...
namespace IS_ZJZ_B.Controllers
{
    ...
    public class AdminworkerController : ControllerBase
    {
        ...
        public async Task<ActionResult<AdministrativeWorker>> PostAW(AdministrativeWorker awr)
        {
            ...
            string mailBody = $"Zdravo {awr.firstName}, <br>" + Environment.NewLine + $"Kreirali smo nalog za vas !" + " <br> " + Environment.NewLine + $"Pristupite sitemu sa mejlom: {awr.email} i sifrom :{awr.pwd} " + " <br> " + Environment.NewLine + $"Nas sistem http://localhost:4200/registeruser ";
